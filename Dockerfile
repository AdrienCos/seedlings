...
ARG PDM_VERSION=2.16.0
ARG COPIER_VERSION=9.2.0
ARG USER_UID=1000

FROM python:${PYTHON_VERSION}@sha256:f6d04873f0a67146854270e5f6513ed5e0165557c1b10689f1a20e9e65c8fe8e as base
ARG USER_UID
