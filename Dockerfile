...
ARG PDM_VERSION=2.26.2
ARG COPIER_VERSION=9.10.3
ARG USER_UID=1000

FROM python:${PYTHON_VERSION}@sha256:595140b768992c05b096570e5ae487a02a2c6b3ae23ba33ce0fc34b99579c98e AS base
ARG USER_UID
